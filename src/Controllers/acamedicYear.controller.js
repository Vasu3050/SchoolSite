...
const createAcademicYear = asyncHandler(async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, academicYear, "Academic year created successfully."));
});
...
const getAllAcademicYears = asyncHandler(async (req, res) => {
    ...
    if (!academicYears || academicYears.length === 0) {
        return res
            .status(200)
            .json(new ApiResponse(200, [], "No academic years found."));
    }

    return res
        .status(200)
        .json(new ApiResponse(200, academicYears, "Academic years fetched successfully."));
});
...
const getAcademicYearById = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, academicYear, "Academic year fetched successfully."));
});
